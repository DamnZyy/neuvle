...
const navigationMenuTriggerStyle = cva(
  "group inline-flex items-center justify-center rounded-md bg-white py-4 transition-colors disabled:pointer-events-none disabled:opacity-50"
)

const NavigationMenuTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Trigger
    ref={ref}
    className={cn(navigationMenuTriggerStyle(), "group text-md font-normal	", className)}
    {...props}>
    {children}{""}
    <ChevronDown
...
const NavigationMenuIndicator = React.forwardRef(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Indicator
    ...
    {...props}>
    <div
      className="relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm bg-default shadow-md dark:bg-slate-800" />
  </NavigationMenuPrimitive.Indicator>
))
